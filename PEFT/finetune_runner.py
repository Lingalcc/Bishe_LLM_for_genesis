...
DEFAULT_PIPELINE_CONFIG = REPO_ROOT / "config" / "pipeline_config.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Unified JSON config path. Will read `finetune.train` section.",
    )
    parser.add_argument(
        "--llamafactory-dir",
        type=Path,
...
def main() -> None:
    ...
    command = _resolve_train_prefix() + ["train", str(config_path)] + method_args + extra_args
